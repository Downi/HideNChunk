...
public enum ConfigC {
	...
	shop_blockShopv1Enabled (true, W.config),
	shop_blockShopv1IDname ("DIAMOND", W.config),
	shop_blockShopv1Price (3000, W.config),
	shop_blockShopv1Name ("%H&lBlock Shop", W.config),
	...
	shop_blockShopv1Description (new String[] {
					"%NUse this item before the arena starts.",
					"%ARight-Click%N in the lobby and choose",
					"%Nthe block you want to buy!", "&6Unlimited uses." }, W.config),
	...
	normal_setwarpWarpSet ("%TAG%NSet warp '%A%warp%%N' to your location!",
			W.messages),
	normal_addedToken ("%TAG%A%amount%%N bytes were added to your account!",
			W.messages),
	...
	error_notenoughmoney ("%TAG%EYou don't have enough Bytes.",
			W.messages),
	shop_boughtblock ("%TAG%ESuccessfully bought %A%block%%E!",
			W.messages);
